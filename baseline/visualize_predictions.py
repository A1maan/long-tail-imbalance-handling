...
class PredictionVisualizer:
    def __init__(self, coco_data_path="/home/almaankhan/data/coco/annotations/instances_val2017.json",
                 predictions_dir="runs/baseline_inference/predictions",
        ...
        self.output_dir = Path("runs/baseline_inference/visualizations")
    ...
    def create_metrics_comparison_chart(self, metrics_summary):
        ...
        ax.set_title('Performance by Class Frequency (Head/Medium/Tail)', fontsize=13, fontweight='bold')
        ax.set_xticks(x)
        ...
        self.create_metrics_heatmap(models, metrics_summary)
...
def run_calculate_class_metrics():
    ...
    if result.returncode == 0:
        ...
        # Try to load the metrics summary
        metrics_file = Path("runs/baseline_inference/metrics_summary.json")
